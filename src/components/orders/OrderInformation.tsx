        ...
        <CardTitle>
          <div className='flex flex-row items-center gap-2'>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6.25 4.05811L13.75 8.34977" stroke="#09090B" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <path d="M2.75 6.3335L10 10.5002L17.25 6.3335" stroke="#09090B" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M10 18.8333V10.5" stroke="#09090B" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-lg">{order?.branch?.title}</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-600">Nguồn bán</p>
            <p className="text-lg">{order?.source}</p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-600">Tổng tiền</p>
            <p className="text-lg font-semibold text-green-600">{order?.total_price ? order.total_price.toLocaleString() : 0}₫</p>
          </div>
        </div>
        {order?.note && (
          <div>
