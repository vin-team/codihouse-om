...
export default function SearchOrder() {
  ...
  const currentPageOrders = useAppSelector((state) => state.search.pagination.orders.currentPage);
  const requestState = useAppSelector(state => state.search.requestState)
  const estimatedTotalHits = useAppSelector(state => state.search.pagination.orders.estimatedTotalHits)
