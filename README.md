...
```
cd existing_repo
git remote add origin https://git.codihaus.com/order-manager/frontend-nextjs.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.codihaus.com/order-manager/frontend-nextjs/-/settings/integrations)
